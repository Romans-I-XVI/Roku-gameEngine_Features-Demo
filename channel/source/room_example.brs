function room_example()
	return function(room)
		...
		room.onDrawBegin = function(frame)
			...
			if m.gameEngine.debug then : frame.DrawText("room: room_example", 10, 720-10-m.gameEngine.Fonts.default.GetOneLineHeight(), &hFFFFFFFF, m.gameEngine.Fonts.default) : end if
		end function
